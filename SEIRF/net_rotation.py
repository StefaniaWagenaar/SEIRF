...
def calculate_net_rotation_internal_gplates(
    ...
    for plate_id, plate_net_rotation_result in iteritems(plate_net_rotations):
        ...
        #print(plate_net_rotation_result.weighting_factor)
        #print(plate_net_rotation_result.rotation_component)
...
class NetRotationResult(object):
    ...
    def get_net_rotation(self):
        ...
        #print(self.weighting_factor)
        #print(self.rotation_component)
        
        
        weighted_rotation_component = (1.0 / self.weighting_factor) * self.rotation_component
        #print(weighted_rotation_component)
...
if __name__ == '__main__':
    ...
    sample_data_path = 'C:/Users/6408885/optAPM-master/optAPM-master/data/Subduction_convergence'
    rotation_features = pygplates.FeatureCollection(os.path.join(sample_data_path, 'Matthews_etal_GPC_2016_410-0Ma_GK07.rot'))
    
    topology_features = [
        pygplates.FeatureCollection(os.path.join(sample_data_path, 'Matthews_etal_GPC_2016_MesozoicCenozoic_PlateTopologies.gpmlz')),
        pygplates.FeatureCollection(os.path.join(sample_data_path, 'Matthews_etal_GPC_2016_Paleozoic_PlateTopologies.gpmlz')),
        pygplates.FeatureCollection(os.path.join(sample_data_path, 'Matthews_etal_GPC_2016_TopologyBuildingBlocks.gpmlz'))]
